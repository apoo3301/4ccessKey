...
import { Users, Rocket, History } from 'lucide-react'
import { Button } from "@/components/ui/button"

const AboutPage = () => {
    // Supprimer l'utilisation de scrollDisabled si non nécessaire
                ...
                <div className="h-full overflow-auto bg-gradient-to-b from-gray-50 to-white">
                    <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
                        ...
                        <div className="mt-16 text-center">
                            ...
                            <Button
                                size="lg"
                                className="bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white font-semibold py-3 px-8 rounded-full shadow-lg transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-105"
                            >
                                Postulez maintenant
                            </Button>
                        </div>
